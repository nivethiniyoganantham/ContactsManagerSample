...
function getGridList(service, $scope, url) {
...
function Save(service, $scope, url, primaryListUrl) {
    ...
    var reloadUrl = (primaryListUrl == null || primaryListUrl === undefined) ? url : primaryListUrl;
        ...
        saveResult.then(function (res) {
            getGridList(service, $scope, reloadUrl);
            $scope.show = false;
...
function Update(service, $scope, url, primaryListUrl) {
    ...
    function ButtonClick($scope, parameter, Constant) {
    ...
    function getlayoutcontrols($scope) {
        $scope.actionButton = [];
        $scope.actionButton.push({ "controlname": 'btnAdd', "tooltip": 'Add', "imageSource": "/content/uibuttons/roundedicons/Add.png", "howerImageSource": "/content/uibuttons/roundedicons/Add_Hover.png", "isdefault": true, "sequencenumber": 1 });
        $scope.actionButton.push({ "controlname": 'btnEdit', "tooltip": 'Edit', "imageSource": "/content/uibuttons/roundedicons/Edit.png", "howerImageSource": "/content/uibuttons/roundedicons/Edit_Hover.png", "isdefault": true, "sequencenumber": 2 });
        $scope.actionButton.push({ "controlname": 'btnDelete', "tooltip": 'Delete', "imageSource": "/content/uibuttons/roundedicons/Delete.png", "howerImageSource": "/content/uibuttons/roundedicons/Delete_Hover.png", "isdefault": true, "sequencenumber": 3 });
        $scope.actionButton.push({ "controlname": 'btnRefresh', "tooltip": 'Refresh', "imageSource": "/content/uibuttons/roundedicons/Refresh.png", "howerImageSource": "/content/uibuttons/roundedicons/Refresh_Hover.png", "isdefault": true, "sequencenumber": 9 });
        $scope.actionButton.push({ "controlname": 'btnSave', "tooltip": 'Save', "imageSource": "/content/uibuttons/roundedicons/Save.png", "howerImageSource": "/content/uibuttons/roundedicons/Save_Hover.png", "isdefault": false, "sequencenumber": 11 });
        $scope.actionButton.push({ "controlname": 'btnCancel', "tooltip": 'Cancel', "imageSource": "/content/uibuttons/roundedicons/Cancel.png", "howerImageSource": "/content/uibuttons/roundedicons/Cancel_Hover.png", "isdefault": false, "sequencenumber": 13 });
        $scope.actionButton.push({ "controlname": 'btnView', "tooltip": 'View', "imageSource": "/content/uibuttons/roundedicons/View.png", "howerImageSource": "/content/uibuttons/roundedicons/icon-View-hover.png", "isdefault": true, "sequencenumber": 4 });
    } 
